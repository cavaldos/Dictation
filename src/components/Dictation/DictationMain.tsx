...
const DictationMain: React.FC = () => {
    ...
    // Use archive videoId if available, otherwise use local state
    const videoId = archiveVideoId || localVideoId;
    ...
    const resetAll = () => {
        ...
        setIsLooping(false);
        setIsStarted(false);
        // Also reset any archive-loaded data
        resetDictation();
    };
                ...
                <div className="w-full max-w-2xl space-y-6">
                    ...
                    <div className="text-center">
                        <h2 className="text-2xl font-bold text-notion-text mb-4">
                            {documentName ? documentName : "Ready to Practice!"}
                        </h2>
